 ...
 *
 * @size: this is the size of the shash table
 * Return: this is the created shash table or NULL if function fails
 */
...
/**
 * add_n_shash - this add a node at the beginning of a shash at a given index
 *
...
/**
 * add_i_shash - this adds a node on the DLL of the shash table
 *
